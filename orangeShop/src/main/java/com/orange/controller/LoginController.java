...
import com.orange.util.MailTest;
...
public class LoginController {
    ...
    public String buyerLogin(HttpServletRequest request, String username, String password, String targetUrl) {
        ...
        if (null == buyer) {
//        	request.setAttribute("targetUrl", "/orangeShop/front/index.shtml");
            return "login";
        }
    ...
    public String forget(String username, String email, HttpServletRequest request) throws MessagingException, IOException {
    				MailTest.sendMail(email, username);
					return "success";
    	
//        try {
//            Properties props = new Properties();
//            props.put("username1", "cumtlfy09@126.com");
//            props.put("password1", "09153595lfy");
...
//            msg.setFrom(new InternetAddress("cumtlfy09@126.com"));
